...
### You can view the image event pictures by running the Image Event Viewer program in the main application directory (this is what a subscriber receiving an image event alert would do). The tkinter, Pillow and os libraries are required : 
